...
export class PendragonFollowerSheet extends api.HandlebarsApplicationMixin(
    sheets.ActorSheetV2) {
    constructor(options = {}) {
      super(options);
    ...
    static DEFAULT_OPTIONS = {
        classes: ["Pendragon", "sheet", "actor", "follower","theme-light"],
        position: {
            width: 425,
            height: 750,
        },
    ...
    static PARTS = {
      header: {
          template: 'systems/Pendragon/templates/actor/follower.header.hbs',
          scrollable: [''],
      }, 
    }
    ...
    async _prepareContext(options) {
      const context = {
        ...
        context.solLabel = context.solType[this.actor.system.sol];
  ...
  _onRender(context, _options) {
    ...
    this.element.querySelectorAll(".close-sheet").forEach(n => n.addEventListener("dblclick", this._onCloseSheet.bind(this)))
